...
let players = [
  ...
  { name: 'CAMILA VALENTINI', role: 'MARKETING FRIVEN', photo: './assets/camila.png', number: 6, flag: '🇧🇷', stars: 5 },
  { name: 'GUSMÃO', role: 'NEGÓCIOS DIGITAIS', photo: './assets/gusmão.png', number: 7, flag: '🇧🇷', stars: 5 },
  { name: 'CAMILA BIONDO', role: 'NEGÓCIOS DIGITAIS', photo: './assets/cami.png', number: 8, flag: '🇧🇷', stars: 5 },
  ...
  { name: 'AMANDA LAZZARI', role: 'MARKETING', photo: './assets/amanda.png', number: 21, flag: '🇧🇷', stars: 5 },
